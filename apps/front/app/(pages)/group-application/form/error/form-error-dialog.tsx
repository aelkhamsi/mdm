      ...
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs space-y-2">
            ...
            <div>
              Veuillez réessayer plus tard <span className="text-black">ou</span> contactez-nous sur l&apos;addresse email <span className="text-blue-500">mdm@mathmaroc.org</span> en précisant votre nom, prénom et en joignant le message de l&apos;erreur çi-haut.
            </div>
          </DialogDescription>
        </DialogHeader>
      </DialogContent>
