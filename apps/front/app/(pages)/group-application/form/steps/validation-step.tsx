            ...
            <div className="space-y-2">
              <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                ...
                <div className="space-y-1 leading-none">
                  ...
                  <FormDescription>
                  Je confirme avoir lu entièrement le règlement <Link className="text-blue-500 font-bold" href="https://drive.google.com/file/d/1pDlpsReVpca6-yFJXt849QQeEhsr7Jon/view?usp=sharing" target="_blank">(lien)</Link> de l&apos;événement et m'engage à le respecter.<br/>
