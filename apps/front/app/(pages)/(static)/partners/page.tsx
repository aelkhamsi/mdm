  ...
  return (
    <div className="w-full max-w-sm md:max-w-7xl px-5 xl:px-0 mt-10">
      <div className="space-y-6">
        ...
        >
          <div 
            className="w-[16rem] md:h-[16rem] md:w-[40rem] bg-white shadow-lg border-b-4 border-red-500 md:flex justify-center items-center rounded-md"
        ...
        <div className="flex justify-around flex-wrap">
          ...
          <div>
            ...
            >
              <div 
                className="w-[16rem] md:h-[16rem] md:w-[36rem] bg-white shadow-lg border-b-4 border-red-500 md:flex justify-center items-center rounded-md"
                key={partners[0].key}
              >
                <div className="h-[8rem] w-[16rem] md:h-fit md:w-[18rem] flex justify-center items-center">
                  <img
          ...
          <div>
            <h1 
              ...
              style={{ animationDelay: "0.30s", animationFillMode: "forwards" }}
            >
              <span className='bg-gradient-to-br from-sky-800 to-[#272162] inline-block text-transparent bg-clip-text'>Co-organisateur</span>
            </h1>
