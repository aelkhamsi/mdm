...
const SecondSection = () => {
  return (    
    <div className='relative isolate overflow-hidden w-full flex flex-col justify-center items-center py-14 bg-slate-50 shadow-2xl shadow-slate-800'>
      ...
      <div
        className="flex flex-col w-full md:flex-row md:justify-between md:space-x-8 lg:w-3/4 text-sm mb-20"
      >
      ...
      >
        <div className="w-full space-y-4 p-4 xl:p-0 xl:pl-[15%]">
        ...
        <div className="w-full space-y-4 font-medium text-4xl p-4 xl:p-0 xl:pl-[5%]">
