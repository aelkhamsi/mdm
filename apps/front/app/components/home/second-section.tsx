...
const SecondSection = () => {
  return (    
    <div className='relative isolate overflow-hidden w-full flex flex-col justify-center items-center py-14 bg-slate-50 shadow-2xl shadow-slate-800'>
      ...
      <div
        className="flex flex-col w-full md:flex-row md:justify-between md:space-x-8 lg:w-3/4 text-base mb-16"
      >
        <div className="w-full space-y-4 p-4">
          <p className='font-bold text-xs text-cyan-600'>Une première édition d'excellence</p>
          <h1 className='font-bold text-3xl'>MDM 2024 avec l&apos;UM6P, une fusion de l'excellence</h1>
      ...
      >
        ...
        <div className="w-full space-y-4 font-medium text-4xl">
