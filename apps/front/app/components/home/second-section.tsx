...
const SecondSection = () => {
  return (    
    <div className='relative isolate overflow-hidden w-full flex flex-col justify-center items-center py-14 bg-slate-50 shadow-2xl shadow-slate-800'>
      ...
      <div
        className="flex flex-col w-full md:flex-row md:justify-between md:space-x-8 lg:w-3/4 text-sm mb-16"
      >
        <div className="w-full space-y-4 p-4">
          <p className='font-bold text-xs text-cyan-600'>Une première édition d'excellence</p>
          <h1 className='font-bold text-2xl'>MDM 2024 avec l&apos;UM6P, une fusion de l'excellence</h1>
          <p className="">L'édition passée de MDM a été tenu à Ben-guerir, en collboration avec l&apos;<span className='font-bold'>UM6P</span></p>
          <p className="">Une édition qui a réuni une centaine de passionnés de mathématique autour de conférences d'expert, de stands et de compétitions. </p>
      ...
      <div
        className="flex flex-col md:flex-row md:justify-between w-full lg:w-3/4 text-sm mt-10"
      >
        <div className="w-full space-y-4 p-4">
        ...
        <div className="w-full space-y-4 p-4 font-medium text-4xl xl:p-0 xl:pl-[5%]">
