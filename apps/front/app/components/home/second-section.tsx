...
const SecondSection = () => {
  return (    
    <div className='relative isolate overflow-hidden w-full flex flex-col justify-center items-center py-14 bg-slate-50 shadow-2xl shadow-slate-800'>
      ...
      <div
        className="flex flex-col w-full md:flex-row md:justify-between md:space-x-8 lg:w-3/4 text-base mb-24"
      >
      ...
      <div
        className="flex flex-col md:flex-row md:justify-between md:space-x-8 w-full lg:w-3/4 text-base mt-10"
      >
        <div className="w-full space-y-4 p-4">
          <p className="">Le &apos;Moroccan Day of Mathematics&apos; (MDM) est un événement dédié aux passionnés de mathématiques, comprenant plusieurs compétitions et activités enrichissantes</p>
          <p className="">Pendant cet événement, les participants pourront s'affronter dans plusieurs compétitions selon leurs niveaux. En plus des compétitions, il y aura des conférences et des stands pour explorer différentes facettes des mathématiques</p>
