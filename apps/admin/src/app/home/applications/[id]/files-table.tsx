...
const FileCard = ({ href }: { href: string }) => {
  ...
  return (
    <Link href={url} target="_blank">
      <div className="w-[6rem] h-[6rem] rounded-xl border flex flex-col justify-center items-center space-y-2 cursor-pointer hover:bg-gray-100">
        <FileIcon />
      </div>
    </Link>
  );
...
const FilesTable = ({ application }: { application: any }) => {
  return (
    <Table>
      <TableHeader>
        <TableRow>
      ...
      <TableBody>
        {application?.fileCnieUrl && (
          <TableRow key="cnie">
            ...
            <TableCell>
              <FileCard href={application?.fileCnieUrl} />
            </TableCell>
          </TableRow>
        )}
        ...
        {application?.fileGradesUrl && (
          <TableRow key="grades">
            ...
            <TableCell>
              <FileCard href={application?.fileGradesUrl} />
            </TableCell>
          </TableRow>
        )}
        ...
        {application?.fileStandAbstractUrl && (
          <TableRow key="parental-authorization">
            <TableCell>Stand Abstract</TableCell>
            <TableCell>
              <FileCard href={application?.fileStandAbstractUrl} />
            </TableCell>
          </TableRow>
        )}
      </TableBody>
