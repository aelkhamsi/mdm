    ...
    <>
      {application ? (
        <Tabs defaultValue="personal-informations" className="space-y-8">
          ...
          <>
            <ApplicationActivityChoices
              activityChoices={activityChoices}
              className="flex flex-start gap-x-2"
            />
          </>
          ...
          <TabsContent value="competition">
            <div className="space-y-6">
              ...
              <Field label="Subject Title">
                {renderText(application?.standSubjectTitle)}
              </Field>
              <Field label="Subject Details">
                {renderText(application?.standSubjectDetails)}
              </Field>
              <Field label="Members">
                {renderText(application?.standMembers)}
              </Field>
